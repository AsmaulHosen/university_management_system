		...
		<body class="fix-header fix-sidebar">
			...
			<div id="main-wrapper">
				...
				<div class="page-wrapper">
					...
					if(count($_POST)>0) {
					mysqli_query($con,"UPDATE category set category_name='$category_name',start_date='$start_date',closure_date='$closure_date',final_closure_date='$final_closure_date'where c_id='$c_id'")or die(mysqli_error());
					echo '<script>window.location.href="magazine.php?update"</script>';
					}else{
					...
					<input  type="text" id="from" name="start_date" class="form-control col-sm-12" value="<?php echo $row['start_date']; ?>" required>
					</div>
					<div class="col-sm-4">
					<label for="to" class="col-sm-12 col-form-label">Closure Date</label>
					<input type="text" id="to" name="closure_date" onclick="go()" class="form-control col-sm-12 " value="<?php echo $row['closure_date']; ?>" required>
					</div>
					<div class="col-sm-4">
					<label for="to" class="col-sm-12 col-form-label">Final Closure Date</label>
					<input type="text" id="last" name="final_closure_date" class="form-control col-sm-12" value="<?php echo $row['final_closure_date']; ?>" required>
					</div>
					</div>
					<div class="form-group row">
					...
					<input type="submit" name="update" value="Update Category"  class="btn btn-block btn-rounded btn-success" style="float:right">
					</div>
					</div>
					</form>
