									...
									<div class="card-body">
										...
										<div class="table-responsive m-t-40">
											<table id="example23" class="display nowrap table table-hover table-striped table-bordered text-center" cellspacing="0" width="100%">
												...
												<?php
													$d= $_SESSION['d_name'];
													$query="SELECT p.id as id,category_name,magazine_title,magazine_desc,CONCAT(u.first_name, ' ' ,u.last_name) as Name ,department,date,post_type,post_status,file_input
													...
													if(mysqli_num_rows($result)>0){
														...
														<tbody>
															<tr>
																...
																<th><a class="btn btn-sm btn-warning" href="pending_post.php?id=<?php echo $row["id"]; ?>">
																	<i class="fa fa-edit"></i>&nbsp; <?php echo $row["post_status"]; ?>
																</a>
																</th>
													...
													if(mysqli_num_rows($result)>0){
														...
														<tbody>
															<tr>
																...
																<th><?php echo $row["date"]; ?></th>
																<th><?php echo $row["post_type"]; ?></th>
																<th><strong><?php echo $row["post_status"]; ?></strong></th>
