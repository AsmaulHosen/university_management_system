			...
			<div id="main-wrapper">
				...
				<div class="page-wrapper">
					...
					<div class="row page-titles">
						...
						<h3 class="text-primary">Magazine - Shorting</h3> </div>
						<div class="col-md-7 align-self-center">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
								<li class="breadcrumb-item active">Shorting</li>
							</ol>
						</div>
					</div>
					<!-- End Bread crumb -->
									...
									<div class="card-body">
										...
										<?php
											...
											if(isset($_POST['update'])){											
												...
												if(count($_POST)>0) {
													mysqli_query($con,"UPDATE post set post_status='$post_status' where id='$id'")or die(mysqli_error());
													echo '<script>window.location.href="magazine_list.php?select"</script>';
													}else{
													echo '<script>window.location.href="magazine_list.php?reject"</script>';
												}
											}
										...
										<div class="basic-form">
											<form autocomplete="off" method="post" >	
												...
												<div class="form-group row">
													<label for="magazine_title" class="col-sm-3 col-form-label">Magazine</label>
												...
												<div class="form-group row">
													<label for="post_status" class="col-sm-3 col-form-label">Post Status</label>
													<div class="col-sm-8" style="fload:right">
														<select name="post_status" id="post_status" class="form-control">										
															<option value="Pending" <?php if ($row['post_status']=='Pending'){echo "selected";}?>>Pending</option>
															<option value="Select" <?php if ($row['post_status']=='Select'){echo "selected";}?>>Select</option>
